        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            <h3 className="text-lg font-medium text-white flex items-center">
              {title}
              <ArrowRight className="ml-2 h-4 w-4 text-gray-400 transform transition-transform duration-200 group-hover:translate-x-1" />
            </h3>
            <p className="mt-2 text-sm text-gray-400 font-normal">{description}</p>
          </div>
        </div>
      </div>
    </a>
