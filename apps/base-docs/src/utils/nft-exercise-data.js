import arraysDeployment from '../../base-camp/assets/deployments/ArraysUT.json';
import basicMathDeployment from '../../base-camp/assets/deployments/BasicMathUnitTest.json';
import controlStructuresDeployment from '../../base-camp/assets/deployments/ControlStructuresUT.json';
import erc20Deployment from '../../base-camp/assets/deployments/ERC20UT.json';
import erc721Deployment from '../../base-camp/assets/deployments/ERC721UT.json';
import errorDeployment from '../../base-camp/assets/deployments/ErrorTriageUT.json';
import importsDeployment from '../../base-camp/assets/deployments/ImportsUT.json';
import inheritanceDeployment from '../../base-camp/assets/deployments/InheritanceUnitTest.json';
import mappingDeployment from '../../base-camp/assets/deployments/MappingsUT.json';
import minimalTokenDeployment from '../../base-camp/assets/deployments/MinimalTokenUT.json';
import newDeployment from '../../base-camp/assets/deployments/NewUT.json';
import storageDeployment from '../../base-camp/assets/deployments/StorageUT.json';
import structsDeployment from '../../base-camp/assets/deployments/StructsUT.json';
...
const NFTExerciseData = {
  1: {
    ...
    url: 'docs/deployment-to-testnet/deployment-to-testnet-exercise',
  },
  2: {
    img: img2,
    ...
    url: 'docs/control-structures/control-structures-exercise',
  },
  3: {
    img: img3,
    title: 'Storage',
    ...
    url: 'docs/storage/storage-exercise',
  },
  4: {
    img: img4,
    title: 'Arrays',
    ...
    url: 'docs/arrays/arrays-exercise',
  },
  5: {
    img: img5,
    title: 'Mappings',
    ...
    url: 'docs/mappings/mappings-exercise',
  },
  7: {
    img: img7,
    title: 'Structs',
    ...
    url: 'docs/structs/structs-exercise',
  },
  8: {
    img: img8,
    title: 'Inheritance',
    ...
    url: 'docs/inheritance/inheritance-exercise',
  },
  10: {
    img: img10,
    title: 'Errors',
    ...
    url: 'docs/error-triage/error-triage-exercise',
  },
  12: {
    img: img12,
    ...
    url: 'docs/new-keyword/new-keyword-exercise',
  },
  13: {
    img: img13,
    ...
    url: 'docs/minimal-tokens/minimal-tokens-exercise',
  },
  14: {
    img: img14,
    title: 'ERC-20 Tokens',
    ...
    url: 'docs/erc-20-token/erc-20-exercise',
  },
  15: {
    img: img15,
    ...
    url: 'docs/erc-721-token/erc-721-exercise',
  },
  19: {
    img: img19,
    title: 'Imports',
    ...
    url: 'docs/imports/imports-exercise',
  },
};
