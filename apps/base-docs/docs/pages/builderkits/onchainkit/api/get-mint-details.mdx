...
[`Promise<GetMintDetailsResponse>`](types#getmintdetailsresponse)

## Parameters

[`GetMintDetailsParams`](types#getmintdetailsparams)

## Types
- [`GetMintDetailsResponse`](types#getmintdetailsresponse)
- [`GetMintDetailsParams`](types#getmintdetailsparams)
