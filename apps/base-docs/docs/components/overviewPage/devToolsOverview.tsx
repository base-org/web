    ...
    <div className=" max-overview-hero:hidden overview-hero:sticky overview-hero:top-8 overview-hero:flex overview-hero:justify-center">
      <div className="w-[320px]">
        <div className="relative">
          ...
          <div className="relative bg-white dark:bg-black shadow-lg border border-gray-200 dark:border-gray-800 rounded-md p-3">
            ...
            <div className="space-y-1">
              {quickstartLinks.map((link: QuickstartLink) => (
                ...
                >
                  <div className="flex items-center justify-between py-1 px-2 rounded hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                    <span className="text-sm text-gray-700 dark:text-gray-300 group-hover:text-[rgb(0,82,255)] line-clamp-1 font-normal">
                      {link.title}
                    </span>
                    <ArrowRight className="h-3 w-3 text-gray-400 group-hover:text-[rgb(0,82,255)] flex-shrink-0" />
                  </div>
                </a>
              ))}
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[480px,1fr] mb-12">
          ...
          <div className="max-w-[480px]">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-50">Tools for Onchain Apps</h1>
            ...
            <div className="mt-6 flex flex-row items-center gap-4 flex-wrap">
              ...
              <a
                ...
                className="inline-flex items-center justify-center px-4 py-2 rounded-md bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 font-medium hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors border border-gray-200 dark:border-gray-700"
              >
        ...
        <div className="mb-16">
          <div className="flex justify-between items-baseline mb-6">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-50">Meet the tools</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {tools.map((tool: Tool) => {
              ...
              return (
                ...
                >
                  <div className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-lg p-4 hover:border-[rgb(0,82,255)] transition-colors h-full flex flex-col shadow-gray-200/50 dark:shadow-none">
                    <div className="flex items-center space-x-3 mb-3">
                      <Icon className="h-5 w-5 text-[rgb(0,82,255)]" />
                      <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 group-hover:text-[rgb(0,82,255)]">
                        {tool.title}
                      </h3>
                    </div>
        ...
        <div className="mb-16">
          <div className="flex justify-between items-baseline mb-6">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-50">Start building</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {useCases.map((useCase: UseCase) => (
              <a
                ...
                className="block group"
              >
                <div className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden shadow-gray-200/50 dark:shadow-none hover:border-[rgb(0,82,255)] transition-colors">
        ...
        <div className="mb-16">
          <div className="flex justify-between items-baseline mb-6">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-50">Explore our guides</h2>
