...
Recommended libraries for handling blockchain and wallet interactions. The example project in the [Quick Start](../quick-start) guide uses all three of these.
