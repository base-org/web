...
import { TopNavigationLink } from './index.tsx';
import Title from '../typography/Title/index.tsx';
import { TitleLevel } from '../typography/Title/types.ts';
        ...
        <div className="fixed inset-0 z-50 overflow-auto bg-black px-[1.75rem] pb-20 pt-5">
          <div className="mb-8 flex items-center justify-between gap-4">
            <Link href="/" className="-ml-3 flex min-h-[2.875rem] min-w-[2.875rem]">
              <img src="logo.svg" alt="Base Logo" />
            </Link>
            <button
              type="button"
              onClick={toggleMenu}
