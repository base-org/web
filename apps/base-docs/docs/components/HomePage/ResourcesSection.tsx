        ...
        {resources.map((resource) => {
          ...
          return (
            <a
              key={resource.title}
              href={resource.link}
              className="group glass-effect rounded-md p-6 bg-gray-50 dark:bg-black shadow-lg shadow-gray-300/50 dark:shadow-none border border-gray-200 dark:border-gray-800 hover:bg-white dark:hover:bg-black transition-colors duration-200"
            >
