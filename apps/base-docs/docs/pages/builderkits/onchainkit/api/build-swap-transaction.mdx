...
[`Promise<BuildSwapTransactionResponse>`](types#buildswaptransactionresponse)

## Parameters

[`BuildSwapTransactionParams`](types#buildswaptransactionparams)

## Types
- [`BuildSwapTransactionResponse`](types#buildswaptransactionresponse)
- [`BuildSwapTransactionParams`](types#buildswaptransactionparams)
