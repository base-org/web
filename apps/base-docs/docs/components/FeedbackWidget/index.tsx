...
export function FeedbackWidget() {
  ...
  return (
    <div className="mt-8 border-t border-gray-200 pt-6 w-full dark:border-neutral-700">
      <div className="flex items-center gap-4">
        <p className="text-sm font-medium text-gray-900 dark:text-neutral-100">Was this page helpful?</p>
          ...
          <button
            ...
            className={`p-2 rounded-full transition-all duration-200 border bg-white
              ${feedback === 'positive' 
                ...
                : 'text-gray-900 border-gray-200 hover:bg-green-50 hover:text-green-600 hover:border-green-500'
          ...
          <button
            ...
            className={`p-2 rounded-full transition-all duration-200 border bg-white
              ${feedback === 'negative'
                ...
                : 'text-gray-900 border-gray-200 hover:bg-red-50 hover:text-red-600 hover:border-red-500'
              } dark:bg-neutral-800 dark:border-neutral-700
              ${feedback === 'negative'
      ...
      {showTextbox && (
        <div className="mt-4 space-y-4">
          ...
          <textarea
            ...
            className="w-full p-3 text-sm border rounded-md bg-white text-gray-900 border-gray-200 placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-neutral-800 dark:text-neutral-100 dark:border-neutral-700 dark:placeholder-neutral-400"
            rows={3}
          />
          ...
          <div className="flex justify-end">
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-white bg-gray-900 hover:bg-gray-800 rounded-md transition-colors duration-200 dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-100"
            >
              Submit Feedback
            </button>
          </div>
