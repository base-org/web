      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[480px,1fr] mb-12">
          ...
          <div className="max-w-[480px]">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-50">Development Guides</h1>
        ...
        <div className="mb-16">
          <div className="flex justify-between items-baseline mb-6">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-50">Use Case Guides</h2>
          </div>
        ...
        <div className="mb-16">
          <div className="flex justify-between items-baseline mb-6">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-50">General Development</h2>
          </div>
