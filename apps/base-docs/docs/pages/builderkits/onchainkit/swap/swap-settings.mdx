...
- [`SwapSettingsReact`](types#swapsettingsreact)
- [`SwapSettingsSlippageDescriptionReact`](types#swapsettingsslippagedescriptionreact)
- [`SwapSettingsSlippageInputReact`](types#swapsettingsslippageinputreact)
- [`SwapSettingsSlippageTitleReact`](types#swapsettingsslippagetitlereact)
