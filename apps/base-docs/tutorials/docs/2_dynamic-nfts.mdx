...
In this tutorial, you will create a dynamic NFT using Irys' [mutable references](https://docs.irys.xyz/developer-docs/mutable-references).
...
You'll use the [Irys CLI](https://docs.irys.xyz/developer-docs/cli) to upload images and metadata.
...
[Download a zip containing PNGs](https://gateway.irys.xyz/MoOvEzePMwFgc_v6Gw3U8ovV6ostgrkWb9tS4baAJhc) for each level, and save them on your local drive.
