...
const sections = [
  ...
  },
  {
    ...
    links: [
      ...
      { text: 'Implement One-Click Checkout', href: '/docs/kits/onchainkit/checkout/checkout' },
  ...
  },
  {
    ...
    links: [
      ...
      { text: 'Drag and Drop Identity Components', href: '/docs/kits/onchainkit/identity/identity' }
    ]
  }
];
    ...
    <div className="mt-16 sm:mt-24">
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
        {sections.map((section) => {
          ...
          return (
            <div key={section.title} className="w-full rounded-md p-6 bg-gray-50 dark:bg-black shadow-lg shadow-gray-300/50 dark:shadow-none border border-gray-200 dark:border-gray-800 hover:bg-white dark:hover:bg-black transition-colors duration-200">
