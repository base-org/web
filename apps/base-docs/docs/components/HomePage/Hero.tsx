  ...
  return (
    <div className="max-home-hero:hidden w-full max-w-sm">
      <div className="relative p-6">
        ...
        <div className="relative bg-white dark:bg-black shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-200/50 dark:border-gray-800 rounded-md p-3">
            ...
            {topGuides.map((item: Guide) => (
              ...
              >
                <div className="flex items-center justify-between py-1.5 px-2 rounded hover:bg-gray-50 dark:hover:bg-gray-800/50">
                  <span className="text-sm text-gray-600 dark:text-gray-400 group-hover:text-[rgb(0,82,255)] line-clamp-1 font-normal">
                    {item.title}
                  </span>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7">
            ...
            <h1 className="mt-6 text-3xl sm:text-4xl font-bold text-gray-900 dark:text-gray-50 leading-tight">
              Build on {' '}
            ...
            <p className="mt-4 text-base sm:text-lg text-gray-600 dark:text-gray-400 max-w-xl font-normal">
            ...
            <div className="mt-6 flex flex-row items-center gap-4 flex-wrap">
              ...
              <a
                href="/docs"
                className="touch-feedback group flex justify-center items-center px-5 py-2.5 text-sm font-medium rounded-md border-2 border-white text-gray-700 dark:border-gray-700 dark:text-gray-300"
                style={{ 
