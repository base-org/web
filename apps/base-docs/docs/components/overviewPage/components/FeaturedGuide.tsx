      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-6">
            ...
            <h2 className="mt-6 text-3xl sm:text-4xl font-bold text-gray-900 dark:text-gray-50 leading-tight">
              {title}
            </h2>
          ...
          <div className="hidden lg:block lg:col-span-5 lg:col-start-8">
            <div className="relative p-6 max-w-sm">
              ...
              <div className="relative bg-white dark:bg-gray-900 shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-200/50 dark:border-gray-800 rounded-md p-3">
                <img
                  src={imageUrl}
                  alt={imageAlt}
