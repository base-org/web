export default [
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_startingBlockNumber', type: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'uint256', name: 'l2OutputIndex', type: 'uint256' },
      { indexed: true, internalType: 'uint256', name: 'l2BlockNumber', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'l1Timestamp', type: 'uint256' },
    ],
    name: 'OutputProposed',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'uint256', name: 'prevNextOutputIndex', type: 'uint256' },
      { indexed: true, internalType: 'uint256', name: 'newNextOutputIndex', type: 'uint256' },
    ],
    name: 'OutputsDeleted',
    type: 'event',
  },
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_l2BlockNumber', type: 'uint256' }],
