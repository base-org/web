      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[480px,1fr] mb-12">
          ...
          <div className="max-w-[480px]">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-50">Get Started with Base</h1>
        ...
        <div className="mb-16">
          <div className="flex justify-between items-baseline mb-6">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-50">Learn the Fundamentals</h2>
          </div>
        ...
        <div className="mb-16">
          <div className="flex justify-between items-baseline mb-6">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-50">Getting Started Guides</h2>
          </div>
