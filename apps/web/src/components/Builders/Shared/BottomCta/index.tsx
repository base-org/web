    ...
    <CtaBanner
      ...
      cta={
        <>
          <button
            type="button"
            className="inline-flex items-center gap-2.5 rounded-lg bg-white px-4 py-3 text-dark-palette-primaryForeground transition-colors hover:bg-white/90"
            onClick={handleCopy}
          >
            npm create onchain
            {hasCopied ? (
          ...
          <ButtonWithLinkAndEventLogging
            ...
            linkClassNames="text-base  text-white block"
