...
like [`<Avatar>`](../identity/avatar), [`<n>`](../identity/name), 
...
Expand the user experience with pre-made components like [`<WalletDropdownLink>`](wallet-dropdown-link),
[`<WalletDropdownBasename>`](wallet-dropdown-basename),
[`<WalletDropdownFundLink>`](wallet-dropdown-fund-link),
...
- [`WalletReact`](types#walletreact)
- [`ConnectWalletReact`](types#connectwalletreact)
- [`WalletDropdownReact`](types#walletdropdownreact)
- [`WalletDropdownBasenameReact`](types#walletdropdownbasenamereact)
- [`WalletDropdownDisconnectReact`](types#walletdropdowndisconnectreact)
- [`WalletDropdownLinkReact`](types#walletdropdownlinkreact)
