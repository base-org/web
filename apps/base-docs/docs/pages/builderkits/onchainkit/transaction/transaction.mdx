...
import TransactionWrapper from '@/components/TransactionWrapper.tsx';
...
[`TransactionDefaultReact`](types#transactiondefaultreact)
...
import { calls } from './calls.ts'; // [!code focus]
...
- [`TransactionButtonReact`](types#transactionbuttonreact)
- [`TransactionError`](types#transactionerror)
- [`TransactionDefaultReact`](types#transactiondefaultreact)
- [`TransactionReact`](types#transactionreact)
- [`TransactionSponsorReact`](types#transactionsponsorreact)
- [`TransactionStatusReact`](types#transactionstatusreact)
- [`TransactionStatusActionReact`](types#transactionstatusactionreact)
- [`TransactionStatusLabelReact`](types#transactionstatuslabelreact)
- [`TransactionToastReact`](types#transactiontoastreact)
- [`TransactionToastActionReact`](types#transactiontoastactionreact)
- [`TransactionToastIconReact`](types#transactiontoasticonreact)
- [`TransactionToastLabelReact`](types#transactiontoastlabelreact)
