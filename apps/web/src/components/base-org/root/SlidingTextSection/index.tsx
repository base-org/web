...
export default function SlidingTextSection() {
  ...
  const text =
    ' Base is for everyone - القاعدة للجميع - Base es para todos - 基地适合所有人 - La Base è per tutti - Base est pour tout le monde - Base ni ya kila mtu - బేస్ అందరి కోసం - बेस सबके लिए है - ';
