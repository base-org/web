...
<img alt="FundCard" src="/images/onchainkit/fund-card.gif" height="364" />
...
```tsx
<FundCard assetSymbol="ETH" country="GB" currency="GBP" />
```
...
<FundCard assetSymbol="ETH" country="US" currency="USD" presetAmountInputs={presetAmountInputs} />;
```
