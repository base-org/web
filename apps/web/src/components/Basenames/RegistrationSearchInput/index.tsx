...
export default function RegistrationSearchInput({
  ...
  const viewBasenameProfile = useCallback(
    () => router.push(`name/${formattedBaseEthDomain}`),
    [formattedBaseEthDomain, router],
  );
    ...
    >
      ...
      <div className={dropdownClasses}>
        ...
        {invalidWithMessage ? (
          ...
          <>
            <button className={buttonClasses} type="button" onClick={viewBasenameProfile}>
              <div className={registeredContentClasses}>
                <span className="truncate">{formattedBaseEthDomain}</span>
                <span className={mutedMessage}> Registered</span>
              </div>
              <ChevronRightIcon width={iconSize} height={iconSize} />
            </button>
