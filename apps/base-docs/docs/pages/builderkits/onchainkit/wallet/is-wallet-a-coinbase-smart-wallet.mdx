...
[`IsWalletACoinbaseSmartWalletResponse`](types#iswalletacoinbasesmartwalletresponse)

## Parameters

[`IsWalletACoinbaseSmartWalletOptions`](types#iswalletacoinbasesmartwalletoptions)
