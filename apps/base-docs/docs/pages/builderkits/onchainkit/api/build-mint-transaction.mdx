...
[`Promise<BuildMintTransactionResponse>`](types#buildminttransactionresponse)

## Parameters

[`BuildMintTransactionParams`](types#buildminttransactionparams)

## Types
- [`BuildMintTransactionResponse`](types#buildminttransactionresponse)
- [`BuildMintTransactionParams`](types#buildminttransactionparams)
