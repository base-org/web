...
es + es-translated # Base Cookie Policy

es + es-translated Last updated: January 17, 2024

---

es + es-translated import CookieManager from '../../../../src/components/CookieManager';

es + es-translated This Cookie Policy explains how Base (referred to here as **"we"**, **"us"** and **"our"**)
...
es + es-translated In some cases, we may use cookies and similar technologies to collect personal information,
...
es + es-translated ## 1. What Are Cookies?

es + es-translated Browser cookies are text files with small pieces of data downloaded onto your computer or
...
es + es-translated ## 2. What Do We Use Cookies For?

es + es-translated When you access our Site and Services, we, or companies we work with, may place cookies
...
es + es-translated ### Strictly Necessary purposes

es + es-translated Strictly Necessary cookies are essential for our Services to function and therefore
...
es + es-translated ### Performance purposes

es + es-translated We use these cookies to count visits and traffic sources so we can measure and improve
...
es + es-translated ## 3. How to Manage Cookies, Similar Technologies and Targeted Online Mobile Advertising

es + es-translated You have the right to decide whether to accept or reject cookies (except strictly necessary
...
es + es-translated There are also additional tools available to manage third party cookies. You can visit the DAA's
...
es + es-translated If you have any questions about our use of cookies or other technologies, please submit
your request to privacy@base.org.

es + es-translated ## 4. Will This Cookie Policy Be Updated?

es + es-translated We may update this Cookie Policy from time to time to reflect, for example, changes to
